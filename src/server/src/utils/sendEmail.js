...
export const sendResetPasswordEmail = async (user, resetToken) => {
    ...
    const mailOptions = {
        ...
        text: `Bạn đã yêu cầu đặt lại mật khẩu. Nhấn vào link sau để thực hiện (hiệu lực trong 10 phút):\n\n${resetLink}\n\nNếu bạn không yêu cầu, hãy bỏ qua email này.`,
        html: `
            <div style="font-family: Arial, sans-serif; max-width: 600px; margin: auto; padding: 20px; border: 1px solid #ddd; border-radius: 10px;">
                ...
                <p>Vui lòng nhấn vào nút bên dưới để đặt lại mật khẩu (link chỉ có hiệu lực trong <strong>10 phút</strong>):</p>
