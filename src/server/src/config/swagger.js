...
const options = {
  definition: {
    ...
    tags: [
  // Public APIs
  { name: 'Authentication', description: 'Đăng ký, đăng nhập, OAuth...' },
  ...
  { name: 'Carts', description: 'Giỏ hàng' },
  { name: 'Orders', description: 'Quản lý đơn hàng' },
  { name: 'Contacts', description: 'Form liên hệ' },
  { name: 'Coupons', description: 'Mã giảm giá' },
  { name: 'Favorites', description: 'Sản phẩm yêu thích' },
  { name: 'Addresses', description: 'Địa chỉ giao hàng' },
  { name: 'Users', description: 'Quản lý thông tin người dùng' },

//   // Admin APIs
//   { name: 'Admin - Brands', description: 'CRUD thương hiệu (Admin)' },
//   { name: 'Admin - Categories', description: 'CRUD danh mục (Admin)' },
//   { name: 'Admin - Products', description: 'CRUD sản phẩm (Admin)' },
//   { name: 'Admin - Product Variants', description: 'CRUD biến thể (Admin)' },
//   { name: 'Admin - Product Images', description: 'Quản lý ảnh sản phẩm (Admin)' },
//   { name: 'Admin - Orders', description: 'Quản lý & xác nhận đơn (Admin)' },
//   { name: 'Admin - Coupons', description: 'CRUD & gán mã giảm giá (Admin)' },
//   { name: 'Admin - Reviews', description: 'Duyệt đánh giá (Admin)' },
//   { name: 'Admin - Users', description: 'Quản lý người dùng & phân quyền' },
//   { name: 'Admin - Roles', description: 'CRUD vai trò' },
//   { name: 'Admin - Contacts', description: 'Quản lý liên hệ khách hàng' },
//   { name: 'Admin - Statistics', description: 'Báo cáo & thống kê' },
],
    components: {
      schemas: {
        User: {
