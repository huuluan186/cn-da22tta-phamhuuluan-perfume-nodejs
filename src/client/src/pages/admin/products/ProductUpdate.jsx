...
import { apiGetProductDetail, apiUpdateProduct, apiCreateVariant, apiAddProductImages, apiDeleteVariant, apiDeleteProductImage, apiSetThumbnail } from "../../../api/product";
...
const ProductUpdate = () => {
    ...
    const handleSubmit = async () => {
        ...
        try {
            ...
            console.error(error);
            toast.error(error.response.data.msg || "Lỗi khi cập nhật sản phẩm");
        }
    };
